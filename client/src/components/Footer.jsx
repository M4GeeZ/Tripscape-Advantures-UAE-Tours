  ...
  return (
    <footer className="footer">
      ...
      <div className="container footer-grid">
        ...
        <div><h4>Experiences</h4><a href="#tours">Desert Safari</a><a href="#tours">Adventures</a><a href="#services">City Tours</a><a href="#tours">Attractions</a></div>
        <div><h4>Destinations</h4><a href="#services">Dubai</a><a href="#services">Abu Dhabi</a><a href="#services">Sharjah</a><a href="#services">Ras Al Khaimah</a></div>
      </div>
