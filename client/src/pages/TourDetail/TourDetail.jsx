...
import { Check, Clock3, MapPin, MessageCircle, Minus, Plus, Star } from 'lucide-react'
        ...
        <section className={`tour-detail-content ${tour.isBookable ? 'is-bookable-tour' : ''}`}>
          <div className="container tour-detail-content__grid">
            <div className="tour-detail-main">
              ...
              {tour.isBookable && tour.description && (
                <p className="tour-detail-description" data-lux-reveal>
                  {tour.description}
                </p>
              )}
